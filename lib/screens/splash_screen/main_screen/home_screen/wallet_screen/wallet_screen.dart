              ...
              child: Column(
                ...
                children: [
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text("Send",style: GoogleFonts.vazirmatn(color: Colors.black,fontSize: 18),)
                                ],
                              ),
                            ),
                          ),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text("Receive",style: GoogleFonts.vazirmatn(color: Colors.black,fontSize: 18),)
                                ],
                              ),
                            ),
                          ),
                  ...
                  Padding(
                    ...
                    child: Text("Transactions",style: GoogleFonts.vazirmatn(color: Colors.black,fontSize: 18),),
                  ),
                  SizedBox(
                    height: screenHeight * 0.02,
                  ),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text("Send",style: GoogleFonts.vazirmatn(color: Colors.black,fontSize: 18),),
                                Text("0xFca318f88f11af575a8C6D9b82b631dC9dA25b85",style: GoogleFonts.vazirmatn(color: Colors.black,fontSize: 8),),
                              ],
                            ),

                            Text("1000 ETH",style: GoogleFonts.vazirmatn(color: Colors.black,fontSize: 18),),
