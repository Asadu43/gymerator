          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text("Do you have an account? ", style: GoogleFonts.barlow(fontSize: 14, color: AppColors.white)),
                  InkWell(
                    onTap: () {
                      Nav.pop(context);
                    },
                    child: Text("Login", style: GoogleFonts.barlow(fontSize: 14, color: AppColors.contentColorPurple)),
                  ),
                ],
              )
            ],
